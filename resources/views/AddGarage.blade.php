...
?>
				...
				Гараж по адрессу '.$_POST["address"].' успешно создан.       
			 </div>';
				}
				?>
			</div>
				...
				<div class="col-lg-12">
					<form method="post">
						...
						<div class="card-box">
							...
							<p class="text-muted font-14 m-b-20"> Для успешного добавления новго бъекта (гаража), необходимо заполнить адрес
